...
export const hoverNoShadow = {
  whileHover: { ...ani.removeBoxShadow }
}
...
const sideBar = {
  ...
  transition: { type: "spring", bounce: 0, duration: .3236 }
}
...
const mainNav = {
  ...
  transition: { type: "spring", bounce: 0, duration: .6472 }
}
...
export const CHILD_VARIANTS_SCALE = {
  visible: { opacity: 1, scale: 1, transition: { type: "spring", duration: 0.3236 } },
